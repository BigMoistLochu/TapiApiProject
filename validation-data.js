export function validate(car) {
    ...
    if (!engine || typeof engine.id !== 'number' ||typeof engine.horsepower !== 'number' || typeof engine.fuelType !== 'string' || typeof engine.capacity !== 'number' || typeof engine.cylinders !== 'number') {
      return false;
    }
